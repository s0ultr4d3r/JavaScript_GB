...
let scrollCh = document.querySelector('.scrollCheck');
...
document.addEventListener('scroll', function(event) {
    if (scrollCh.getBoundingClientRect().top <= window.innerHeight) {
        insertPosts();
    }
});
...
function insertPosts() {
    ...
    scrollCh.insertAdjacentHTML('beforebegin', postsMarkup);
}
